...
import Favicon from '@assets/images/favicon_img.png';
...
function MainLayout({ children }) {
  return (
    <Fragment>
      <Helmet>
        <title>{GroomBrideDetails.firstName} ❤️ {GroomBrideDetails.secondName} Wedding</title>
        ...
        <meta name="twitter:title" content="The Wedding of A & In" />
